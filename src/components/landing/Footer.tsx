                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm">
                            <li><Link href="#" className="hover:text-white transition-colors">Jr Sports Clinics</Link></li>
                            <li><Link href="#" className="hover:text-white transition-colors">Jr STEM Labs</Link></li>
                            <li><Link href="#" className="hover:text-white transition-colors">Jr Defense Training</Link></li>
                            <li><Link href="#" className="hover:text-white transition-colors">Seasonal Camps</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm">
                            ...
                            <li><Link href="#" className="hover:text-white transition-colors">For Cities & Rec</Link></li>
                            <li><Link href="#" className="hover:text-white transition-colors">For HOAs & Apartments</Link></li>
                            <li><Link href="#" className="hover:text-white transition-colors">Revenue Share Inquiries</Link></li>
                        </ul>
                    </div>
