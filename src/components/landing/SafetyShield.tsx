            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <div className="relative rounded-[3rem] overflow-hidden shadow-2xl border-4 border-white/10 aspect-[4/5] group">
                            <motion.img
                            ...
                            <div className="absolute bottom-10 left-10 right-10">
                                ...
                                >
                                    <div className="h-12 w-12 rounded-full border-2 border-primary/50 overflow-hidden">
                                        <img src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=100" alt="Sarah" className="w-full h-full object-cover" />
                                    </div>
                                    <div>
                                        <p className="font-bold text-xl text-white">Coach Sarah</p>
                                        <p className="text-sm text-primary font-bold">LEGITIMACY GUARANTEED</p>
                                    </div>
                                </motion.div>
                            </div>
                        </div>
